...
Option 1: If you run a newer version of the UEM installer, the MSI installer will ask you for a license file. If you specify a new license file, the MSI installer will copy that new license file to the local installation folder of UEM during the upgrade. This works for both manual and unattended MSI installations.

Option 2: If you have a new license file, you can simply rename that file to “FlexEngine.lic” and copy it to the installation folder of the UEM agent, overwriting the exiting license file. This needs to be done for each computer where the UEM agent is installed.
