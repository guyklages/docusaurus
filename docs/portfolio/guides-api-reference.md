...
|--------------|------------------|---------------|:-----------------:|-----------|
| <DefTerm def="FIS (Fidelity) bought fintech startup Atelio and later dissolved it to return to traditional banking.">Atelio&nbsp;of&nbsp;FIS</DefTerm> | **[Quickstart](https://guyklages.com/atelio/getting-started/quickstart)** | _Product discontinued._ <br/> **[Similar&nbsp;to&nbsp;Nium's](https://docs.nium.com/api#description/introduction)** | 1 editor, 5 SMEs | [Revamped and reduced the developer pages by 40%](./most-impactful-tech-writing.md#40-fewer-pages) |
