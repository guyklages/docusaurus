...
| Example submitted: <br/> HP’s Orientation Table with URLs written out, printed on 14 pages | Became 2 pages (1 piece of paper) since: <br/> - 34% more print area (49.5 to 75 in<sup>2</sup>) <br/> - 17% more words per page (12pt to 10pt) <br/> - Saved 20-30% of paper printed |
