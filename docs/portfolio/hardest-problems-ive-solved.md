...
|-------------------|------------------|
| PROBLEM: <br/> - Create a new style of English-learning club in China--a very saturated market. <br/> - Tailor classes to the local people. <br/> - Find venues and topics interesting to locals. <br/> - Find class times in the local's busy schedules. | MY SOLUTION: <br/> Created a database for the various media: <br/> - English slang textbooks <br/> - Daily Mini-Adventures (2-hr class) <br/> - Weekend Adventures (5-hr activity) <br/> - Daily Phrase-of-the-day SMS texts <br/> - Taught classes to improve materials. |
