...
| Before (May 2024) | After (July 2025) |
|-------------------|-------------------|
| PROBLEM: <br/> Pages were hastily written by engineers just to have "something" documented about their products, such as: <br/> <br/> [Payins](https://mpdocs.nium.com/payout-payin/pay-in---key-concepts) <br/> [Payouts](https://mpdocs.nium.com/payout-payin/Payout) | SOLUTION: <br/> I revamped and organized the pages with many more details and related concepts as well as adding many new pages, such as: <br/> <br/> [Payins](https://docs.nium.com/docs/payins) <br/> [Payouts](https://docs.nium.com/docs/payouts) <br/> [Cards](https://docs.nium.com/docs/cards) <br/> [Verify](https://docs.nium.com/docs/verify) <br/> [Foreign exchange](https://docs.nium.com/docs/foreign-exchange) <br/> [Transactions](https://docs.nium.com/docs/transactions) <br/> [Reports](https://docs.nium.com/docs/reports) <br/> [Open banking](https://docs.nium.com/docs/open-banking) <br/> [Use cases](https://docs.nium.com/docs/use-cases) <br/> [Fees and limits](https://docs.nium.com/docs/fees-and-limits) <br/> [Nium portal](https://docs.nium.com/docs/nium-portal) <br/> [Developers](https://docs.nium.com/docs/developers) |
