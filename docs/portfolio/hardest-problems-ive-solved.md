...
### Visualization of a company reorg

#### <mark> Applied Materials (Santa Clara) -- Displayed dynamically how different company reorgs would affect the whole </mark>
...
### 3 departments unified with a database
