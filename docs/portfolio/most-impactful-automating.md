...
|-----------------|------|---------|
| Reduced obsolete pages by 40% and added automation to prevent obsolete pages | 2019 | Yahoo <br/> <sup> _Sunnyvale, CA_ </sup> |
| Made a database to automate reports; saved >50% of the employees' time and effort | 2009 | ADP Payroll <br/> <sup> _Seattle, WA_ </sup> |
| Automated their label printing system; freed up 40% of staff's time | 1999 | Bridgestone <br/> <sup> _Bloomington, IL_ </sup> |
