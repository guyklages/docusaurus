...
| [Ran SQL queries to uncover a $1 million discrepancy in monthly rent totals](#1-million-per-month-saved) | A mall landlord |
| [Created DITA-like database to reuse paragraphs of text in multiple contracts](#law-contracts-that-reuse-text) | A law firm |
| [Displayed dynamically how different company reorganization scenarios would affect the whole](#company-reorg-visualization) | AMAT |
| [Removed 1,000s of duplicate records while database was in production](#1000s-of-duplicates-in-prod) | Komodo |
| [Unified the Marketing, Testing, and Sales departments with a database](#3-dept-unified-with-a-db) | Lung Electronics |
...
| Before | After |
|--------|-------|
| PROBLEM: <br/> Daily&nbsp;call&nbsp;queue&nbsp;of&nbsp;120+&nbsp;customers&nbsp;never&nbsp;reduced. <br/> <br/> Each day, the director _randomly_ chose a _single_ time zone of North American customers to be called: <br/> <br/> 1. Call the customer's _home_. <br/> 2. If no answer, call their _office_, but only on _another_ day. <br/> 3. If the 2nd call wasn’t answered, the case was _closed_ as “unanswered”. <br/> ![Map](../../static/img/USA-colored_timezones.png) | MY SOLUTION: <br/> Call customers' preferred number at preferred time. <br/> <br/> 1. I was hired to manage a call center where staff would write down customers' issues for Microsoft Engineers to reply; instead, I saw many issues I knew the answer to and solved most of them while the customers were on the phone. <br/> <br/> 2. I redesigned their website and system to: <br/> - Use customers' preferred phone number and time. <br/> - Sort calls by time zone of customers’ preferred time. |
| (10 calls) / (120 calls) = 8% | RESULTS: <br/> - Queue reduced from 120 to 10 calls in 2 weeks. <br/> - Duplicate and repeated calls reduced to 0. <br/> - Customer satisfaction skyrocketed due to me solving most of their questions on the phone. |
